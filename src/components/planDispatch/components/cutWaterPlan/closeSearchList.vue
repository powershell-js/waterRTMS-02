    ...
    <div style="height:100%">
        ...
        <div class="table-wrapper">
            <template >
                ...
                <div class="pagination-wrapper" v-show="cur=='closeList'">
             ...
             <template >
                <div class="inner-table" v-show="cur=='userList'">
                    ...
                    <el-table-column prop="Pressure" label="压力（m）"></el-table-column>
                    <el-table-column prop="Addr" label="地址"></el-table-column>
                    </el-table>
                </div>

                <div class="pagination-wrapper" v-show="cur=='userList'">
...
import axios from "axios"
    export default {
        ...
        watch:{
            gfssList(){
                this.page_total1 = this.gfssList.length;
                this.gfssListData = this.gfssList.slice(0,this.pageSize);
            },
            tsyhList(){
                this.page_total2 = this.tsyhList.length;
                this.tsyhListData = this.tsyhList.slice(0,this.pageSize);
            },
        },
        data(){
        ...
        methods:{
           ...
           handleCurrentChange1(val){
               ...
               this.gfssListData = this.gfssList.slice((this.currentPage1 - 1) * this.pageSize,this.pageSize * this.currentPage1);
           },
           handleCurrentChange2(val){
               this.currentPage2 = val;
               this.tsyhListData = this.tsyhList.slice((this.currentPage2 - 1) * this.pageSize,this.pageSize * this.currentPage2);
           },
        },
        computed: {
            boundaryData() {
