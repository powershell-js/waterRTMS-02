<template>
    <div class="keduoutbox">
       <div class="koutbox1"><!-- <img id="slidingImg" src="@/assets/img/时间刻度_10.png" alt=""> --></div>
    </div>
</template>
<script>
export default {
  ...
  methods: {
    LopTime() {
      ...
      let localnum = parseInt(total / 15)+1;
      let Insetlinelocation =326 + localnum * parseFloat(760 / 96);
        console.log(localnum);
      document.getElementById("slidingImg").style.left = Insetlinelocation + "px";
