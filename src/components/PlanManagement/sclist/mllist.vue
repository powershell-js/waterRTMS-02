...
/* import ListTable from '@/components/PlanManagement/sclist/mllistecharts/listtable' */
import ListTable from "@/components/PlanManagement/sclist/bjslistecharts/listtable"
import Echarts1 from "@/components/PlanManagement/sclist/mllistecharts/echarts1";
import Echarts2 from "@/components/PlanManagement/sclist/mllistecharts/echarts2";
import Echarts3 from "@/components/PlanManagement/sclist/mllistecharts/echarts3";
import Echarts4 from "@/components/PlanManagement/sclist/mllistecharts/echarts4";
import Echarts5 from "@/components/PlanManagement/sclist/mllistecharts/echarts5";
export default {
 name:"MlList",
  components:{
    ListTable,
