...
/* import ListTable from '@/components/PlanManagement/sclist/dynlistecharts/listtable' */
import ListTable from "@/components/PlanManagement/sclist/bjslistecharts/listtable"
import Echarts1 from "@/components/PlanManagement/sclist/dynlistecharts/echarts1";
import Echarts2 from "@/components/PlanManagement/sclist/dynlistecharts/echarts2";
import Echarts3 from "@/components/PlanManagement/sclist/dynlistecharts/echarts3";
import Echarts4 from "@/components/PlanManagement/sclist/dynlistecharts/echarts4";
import Echarts5 from "@/components/PlanManagement/sclist/dynlistecharts/echarts5";
export default {
 name:"DynList",
  components:{
    ListTable,
