...
/* import Line from "@/view/index/keduline/line" */
import ListTable from "@/components/PlanManagement/sclist/bjslistecharts/listtable";
import Echarts1 from "@/components/PlanManagement/sclist/bjslistecharts/echarts1";
import Echarts2 from "@/components/PlanManagement/sclist/bjslistecharts/echarts2";
import Echarts3 from "@/components/PlanManagement/sclist/bjslistecharts/echarts3";
import Echarts4 from "@/components/PlanManagement/sclist/bjslistecharts/echarts4";
import Echarts5 from "@/components/PlanManagement/sclist/bjslistecharts/echarts5";
export default {
  name: "BjsList",
  components: {
    ListTable,
