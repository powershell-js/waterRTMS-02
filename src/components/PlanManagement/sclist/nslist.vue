...
/* import ListTable from '@/components/PlanManagement/sclist/nslistecharts/listtable' */
import ListTable from "@/components/PlanManagement/sclist/bjslistecharts/listtable"
import Echarts1 from "@/components/PlanManagement/sclist/nslistecharts/echarts1";
import Echarts2 from "@/components/PlanManagement/sclist/nslistecharts/echarts2";
import Echarts3 from "@/components/PlanManagement/sclist/nslistecharts/echarts3";
import Echarts4 from "@/components/PlanManagement/sclist/nslistecharts/echarts4";
import Echarts5 from "@/components/PlanManagement/sclist/nslistecharts/echarts5";
export default {
  name:"NsList",
   components:{
    ListTable,
