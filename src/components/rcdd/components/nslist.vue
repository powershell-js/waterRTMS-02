...
import Rulertop from "@/components/rcdd/components/nslistecharts/topruler/ruler";
import Rulerbottom from "@/components/rcdd/components/nslistecharts/bottomruler/ruler";
import ListTable from "@/components/rcdd/components/listtable";
import Echarts1 from "@/components/rcdd/components/nslistecharts/echarts1";
import Echarts2 from "@/components/rcdd/components/nslistecharts/echarts2";
import Echarts3 from "@/components/rcdd/components/nslistecharts/echarts3";
import Echarts4 from "@/components/rcdd/components/nslistecharts/echarts4";
import Echarts5 from "@/components/rcdd/components/nslistecharts/echarts5";
export default {
  name:"NsList",
   components:{
    ListTable,
...
　　　　　/* console.log(`echats1msg传来的数据是：${e}`) */
  ...
  methods: {
    LopTime() {
      ...
      document.getElementById("slidingImglinens").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinens").style.left =tInsetlinelocationline+2 + "px";
    document.getElementById("slidingImglinens2").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinens2").style.left =tInsetlinelocationline +2+ "px";
       document.getElementById("slidingImglinens3").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinens3").style.left =tInsetlinelocationline +2+ "px";
       document.getElementById("slidingImglinens4").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinens4").style.left =tInsetlinelocationline4+2 + "px";
       document.getElementById("slidingImglinens5").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinens5").style.left =tInsetlinelocationline5+2+ "px";
    },
      content1(){
              this.cont1=false;
              this.cont11=true;
