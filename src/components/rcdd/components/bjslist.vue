...
<div class="box" :style="{height:tablistHeight+'px'}">
    ...
    <div class="contentbox3-1" v-show="cont31">
        <div class="titlebox3-1">
            ...
            <ul class="listbox3-1">
            <li>当前清水池水位<span class="num3-1">{{echats3message.CtWaterPoolLevel}}</span></li>
            <li>预测清水池水位<span class="num3-1">{{echats3message.FctWaterPoolLevel}}</span></li>
        </ul>
        </div>
        <div class="titlebox3-2">
             <!-- 指针线 -->
         <div id="slidingImgline3"></div>
            <div class="inbox-echart">
                 <Echarts3/>
            </div>
        </div>
...
import Rulertop from "@/components/rcdd/components/topruler/ruler";
import Rulerbottom from "@/components/rcdd/components/bottomruler/ruler";
import ListTable from "@/components/rcdd/components/listtable";
import Echarts1 from "@/components/rcdd/components/bjslistecharts/echarts1";
import Echarts2 from "@/components/rcdd/components/bjslistecharts/echarts2";
import Echarts3 from "@/components/rcdd/components/bjslistecharts/echarts3";
import Echarts4 from "@/components/rcdd/components/bjslistecharts/echarts4";
import Echarts5 from "@/components/rcdd/components/bjslistecharts/echarts5";
export default {
  name: "BjsList",
  components: {
    ListTable,
  ...
  methods: {
    LopTime() {
      ...
      document.getElementById("slidingImgline").style.left =
        Insetlinelocationline + "px";
      document.getElementById("tslidingImgline").style.left =
        tInsetlinelocationline + 2 + "px";
      document.getElementById("slidingImgline2").style.left =
        Insetlinelocationline + "px";
      document.getElementById("tslidingImgline2").style.left =
        tInsetlinelocationline + 2 + "px";
      document.getElementById("slidingImgline3").style.left =
        Insetlinelocationline + "px";
      document.getElementById("tslidingImgline3").style.left =
        tInsetlinelocationline + 2 + "px";
      document.getElementById("slidingImgline4").style.left =
        Insetlinelocationline + "px";
      document.getElementById("tslidingImgline4").style.left =
        tInsetlinelocationline4 + 2 + "px";
      document.getElementById("slidingImgline5").style.left =
        Insetlinelocationline + "px";
      document.getElementById("tslidingImgline5").style.left =
        tInsetlinelocationline5 + 2 + "px";
    },
    content1() {
      this.cont1 = false;
      this.cont11 = true;
    ...
    handleParentClick(e) {
      /*  alert("123456") */
      this.$refs.sun.handleSunClick("s");
    }
  }
};
</script>
