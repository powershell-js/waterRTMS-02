...
import Rulertop from "@/components/rcdd/components/mllistecharts/topruler/ruler";
import Rulerbottom from "@/components/rcdd/components/mllistecharts/bottomruler/ruler";
import ListTable from "@/components/rcdd/components/listtable";
import Echarts1 from "@/components/rcdd/components/mllistecharts/echarts1";
import Echarts2 from "@/components/rcdd/components/mllistecharts/echarts2";
import Echarts3 from "@/components/rcdd/components/mllistecharts/echarts3";
import Echarts4 from "@/components/rcdd/components/mllistecharts/echarts4";
import Echarts5 from "@/components/rcdd/components/mllistecharts/echarts5";
export default {
 name:"MlList",
  components:{
    ListTable,
...
　　　　　/* console.log(`echats1msg传来的数据是：${e}`) */
  ...
  methods: {
    LopTime() {
      ...
      document.getElementById("slidingImglinem").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinem").style.left =tInsetlinelocationline +2+ "px";
    document.getElementById("slidingImglinem2").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinem2").style.left =tInsetlinelocationline+2 + "px";
       document.getElementById("slidingImglinem3").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinem3").style.left =tInsetlinelocationline +2+ "px";
       document.getElementById("slidingImglinem4").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinem4").style.left =tInsetlinelocationline4+2 + "px";
       document.getElementById("slidingImglinem5").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinem5").style.left =tInsetlinelocationline5+2+ "px";
    },
      content1(){
              this.cont1=false;
              this.cont11=true;
