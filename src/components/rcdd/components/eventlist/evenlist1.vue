...
<div class="box" :style="{height:evenlistHeight+'px'}">
    <div class="inbox" v-for="(item,index) in list" :key="index" @click="eventSelect(item,index)">
            <!-- 第一部分 -->
    <div class="contentbox1" :id="index" :class="{'active': i == index}">
        <div class="titlebox">
