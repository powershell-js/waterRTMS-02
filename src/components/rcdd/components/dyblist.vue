...
import Rulertop from "@/components/rcdd/components/dyblistecharts/topruler/ruler";
import Rulerbottom from "@/components/rcdd/components/dyblistecharts/bottomruler/ruler";
import ListTable from "@/components/rcdd/components/listtable";
import Echarts1 from "@/components/rcdd/components/dyblistecharts/echarts1";
import Echarts2 from "@/components/rcdd/components/dyblistecharts/echarts2";
import Echarts3 from "@/components/rcdd/components/dyblistecharts/echarts3";
import Echarts4 from "@/components/rcdd/components/dyblistecharts/echarts4";
import Echarts5 from "@/components/rcdd/components/dyblistecharts/echarts5";
export default {
  name:"DybList",
    components:{
    ListTable,
...
　　　　　/* console.log(`echats1msg传来的数据是：${e}`) */
  ...
  methods: {
      ...
      document.getElementById("slidingImglineb").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineb").style.left =tInsetlinelocationline+2 + "px";
    document.getElementById("slidingImglineb2").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineb2").style.left =tInsetlinelocationline +2+ "px";
       document.getElementById("slidingImglineb3").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineb3").style.left =tInsetlinelocationline+2 + "px";
       document.getElementById("slidingImglineb4").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineb4").style.left =tInsetlinelocationline4 +2+ "px";
       document.getElementById("slidingImglineb5").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineb5").style.left =tInsetlinelocationline5+2+ "px";
    },
      content1(){
              this.cont1=false;
              this.cont11=true;
