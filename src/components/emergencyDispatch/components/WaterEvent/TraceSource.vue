...
export default {
    ...
    data() {
        return {
            WaterCol: [{title: '出厂余氯(mg/L)', field: 'Chlorine'},{title: '出厂浊度(NTU)', field: 'Turbidity'},{title: 'pH', field: 'PH'}],
            SewageCol: [{title: '余氯(mg/L)', field: 'Chlorine'},{title: '浊度(NTU)', field: 'Turbidity'},{title: 'pH', field: 'PH'}]
        }
    },
}
</script>
