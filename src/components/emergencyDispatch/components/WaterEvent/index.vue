        ...
        <div class="water-point">
            <el-row type="flex">
                ...
                <el-col :span="3" class="block">
                    <number-block :data="{name:'余氯(mg/L)',value:MaxWaterQualityPoint.Chlorine,unit:'0.70',color:'#70991F'}"></number-block>
                </el-col>
                <el-col :span="3" class="block">
    ...
    TraceabilityAnalysisClick() {
      ...
      this.$axios
        ...
        .then(R => {
          ...
          self.SourceData.ChlorineSpatialCurveData = R.data.ChlorineSpatialCurveData.reverse();
          self.SourceData.PHSpatialCurveData = R.data.PHSpatialCurveData.reverse();
          self.SourceData.TurbiditySpatialCurveData = R.data.TurbiditySpatialCurveData.reverse();
        });
      this.SourceAnalysis();
    },
