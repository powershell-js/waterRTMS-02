    ...
    <div class="booster">
        <div class="set-wrapper clearfix">
            ...
            <div style="float:right">
                <div class="boomWater">
                    <span class="spanStyle">爆管泄水量</span>
                     <el-select style="width:100px" v-model="demandValue" v-on:change="chooseSelection"><!--v-on:change="chooseSelection"-->
                        <el-option
                    ...
                    <el-input class="water_input" v-model="parameter.Demand" v-on:change='inputChange'></el-input><span>m³/h</span>
                </div>
                <div class="boomNum">
...
export default {
  ...
  data() {
    return {
      selections:[
        {index:0,value:0,label:'严重爆管'},
        {index:1,value:1,label:'一般爆管'}
      ],
      demandValue:0,
      parameter: {
        Demand: 1000,
  ...
  methods: {
    chooseSelection:function(){
      if(this.demandValue==0)
        this.parameter.Demand = 1000;
      else 
        this.parameter.Demand = 500;
    },
    ...
    myEventListener: function(event) {
      ...
      if (typeTemp == "PipeBurstMapClickReturn") {
        ...
        this.listItems[1].value = Number(DownHeadMax).toFixed(3);
        this.listItems[2].value = Number(DownHeadMax-1).toFixed(3);
