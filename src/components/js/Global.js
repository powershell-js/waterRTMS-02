export default{
    ...
    /* pressureColor:[[255,69,0,0.6],[255,99,71,0.5],[233,150,122,0.3],[255,127,80,0.2],[255,160,122,0.1]],
    pressureWidth:[5,10,15,20,30], */
    ...
    pipeSlopIsDisplay:[true,true,true,true,true],
     ...
     demandIsDisplay:[true,true,true,true,true],
      ///////////////////供水分界线/////////////////////////////////////////
    pipeSupplyAreaLimit:[2467691,2467688,2750726,193289],
    pipeSupplyAreaColor:["#ff0000","#00c7ff","#CDCDB4","#ffaa00"],
    pipeSupplyAreaWidth:[6,6,6,6],
    pipeSupplyCompareAreaWidth:[2,2,2,2],
    pipeSupplyAreaIsDisplay:[true,true,true,true],
    pipeSupplyAreaLabels:['一期清水池','二期清水池','水厂出口','平水江水厂'],
     ///////////////////管龄/////////////////////////////////////////
