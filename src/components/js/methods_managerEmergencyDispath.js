    ...
    return content;
        ...
        window.addEventListener('event_name',function(event){
                ...
                else if(typeMy=="DrawAccuracyMonitor")
                {
                    ...
                    var limitFlow = drawClass.DrawPipeFlowChange(drawData.min, drawData.max, 
                        drawData.allData, global.diffusionLevel, global.pressureChangColor, pressureDisplays, flowLayer,
                        isCompare, selectTypeMain, "PlanTempCalculate", true, true);
