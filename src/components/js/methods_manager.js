...
class Methods {
    loadArcgis() {// 该方法用于加载 arcgis 依赖的js,css 等
        esriLoader.loadScript({ // 加载js
             ...
             //url:'../../../../static/arcgis_js_api/library/3.25/3.25/init.js',
            dojoConfig: {
                async: true
            },
        });
       ...
       esriLoader.loadCss('https://112.64.170.158:8012/ztdata/library/3.25/3.25/esri/css/esri.css');
        ...
        //esriLoader.loadCss('../../../../static/arcgis_js_api/library/3.25/3.25/esri/css/esri.css');
        //esriLoader.loadCss('../../../../static/arcgis_js_api/library/3.25/3.25/dijit/themes/tundra/tundra.css');
        // 加载模块
