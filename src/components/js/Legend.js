...
,allPipeStrengthLength,diffusionResultClass,EventTypeMain,timeMyMain,timeMyMain1,timeMyMain2,tableNameMain,opType){
        var legendData = {
        }
        ...
        planCalTempStrengthLegendList,allPipeStrengthLength,labelsAll,EventTypeMain);
    }
         ...
         */
        LegendMainPlanTempCalPipe(planTempCalFlowLimit,planTempCalVelocityLimit,tableNameMain,opType)
        {
            ...
            legendData.TableName = tableNameMain;
            this.GetLegendCalPipeLengthData(legendData,tableNameMain,opType)
        }
        ...
        */
        GetLegendCalPipeLengthData(legendData,tableName,opType){
            ...
            axios.post(
             ...
             .then(function(respone){
                self.GetLegendCalPipeLengthDataReturn(respone,global.pressureChangColor,isDisplays,tableName,opType);
             }
            )
        }
         ...
         * @param {*} isDisplays 
         */
        GetLegendCalPipeLengthDataReturn(respone,colorLegend,isDisplays,tableName,opType){
            ...
            var itemType = 'flow';
            objTemp = this.GetLegendDisplayData(flowLegendList,colorLegend,isDisplays,itemType,labelsAll) 
            ...
            console.log(velocityLegendList)
            objTempVelocity = this.GetLegendDisplayData(velocityLegendList,colorLegend,isDisplays,itemType,labelsAll) 
            ...
            new Object(),"PlanTempCalculate",0,0,0,tableName,opType);
        }
    ...
    GetLegendPipeLengthDataReturn(response,colorLegend,isDisplays,itemType,titleName,legendName,compreType,
        ...
        allPipeLengthPipeVelocity,allLabel,EventTypeMain,opType)
        {
        var legendPipeLengthData = response.data;
        var legendList = new Array(); 
    ...
    GetLegendPIpeLengthData(legendData,colorLegend,isDisplays,itemType,titleName,legendName,compreType,
        maxMain,minMain,isCompare,planCalTempFlowLegendList,allPipeLengthPipe,planCalTempVelocityLegendList,
        allPipeLengthPipeVelocity,allLabel,EventTypeMain){
        var self = this;
         ...
         .then(function(respone)
        {
            self.GetLegendPipeLengthDataReturn(respone,colorLegend,isDisplays,itemType,titleName,legendName,compreType,
                maxMain,minMain,isCompare,planCalTempFlowLegendList,allPipeLengthPipe,planCalTempVelocityLegendList,
                allPipeLengthPipeVelocity,allLabel,EventTypeMain,legendData.opType);
        })
    }
    ...
    ClassifyFunction(type,isDisplays,isCompare,allLegendDisplay,isAllDisplay){
        ...
        if(type=="Flow")
        {
            ...
            if(isCompare)
            {
                ...
                colorLegend = global.pressureChangColor;
                if(isDisplays.length==0)
