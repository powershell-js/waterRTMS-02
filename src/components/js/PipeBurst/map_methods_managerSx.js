    ...
    initMap(obj) { // 初始化地图,并设置中心点等
        ...
        window.addEventListener('event_name', function (event) {
            ...
            if (typeMy == "PipeBurstMapClick") {
                ...
                var limitFlow = drawClass.DrawPipeFlowChange(drawData.min, drawData.max, drawData.allData, global.diffusionLevel,
                     global.pressureChangColor, pressureDisplays, flowLayer,
                    isCompare, selectTypeMain, "PlanTempCalculate", true, true);
                    planTempCalFlowLimit = limitFlow.slice(0);
                var limitPressure = drawClass.DrawPressureChange(drawData.minP, drawData.maxP, drawData.NodePressure, 
                    global.diffusionLevel, global.pressureChangColor, flowDisplays, pipeBurstNodeLayer,
                    isCompare, selectTypeMain, "PlanTempCalculate", true, true);
