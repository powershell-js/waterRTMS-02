...
class Methods {
    loadArcgis() {// 该方法用于加载 arcgis 依赖的js,css 等
        esriLoader.loadScript({ // 加载js
            //url: 'http://' + location.host + '/static/dojo/dojo.js',
             ...
             url:'https://10.200.6.71:8085/ztdata/library/3.25/3.25/init.js',
            dojoConfig: {
                async: true
            },
        });
        ...
        esriLoader.loadCss('https://10.200.6.71:8085/ztdata/library/3.25/3.25/esri/css/esri.css');
        esriLoader.loadCss('https://10.200.6.71:8085/ztdata/library/3.25/3.25/dijit/themes/tundra/tundra.css');
        // 加载模块
    ...
    initMap(obj) { // 初始化地图,并设置中心点等
        ...
        function CreateLabel(textTemp,attributesTemp,i)
        {
            ...
            attributesTemp[i].originalData = textTemp;
            return spantext2;
        }
    ...
    return content;
        ...
        function GetChangeAttribute(attributesTemp){
            ...
            for(var i=0;i<attributesTemp.length;i++)
            {
                ...
                {
                    selectElement.ElementId = itemTemp.originalData;
                }
            }
