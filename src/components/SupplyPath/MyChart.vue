  ...
  methods: {
    ...
    drawLine() {
      ...
      myChart.on("click", function(params) {
        // 控制台打印数据的名称
        var obj = self.listData.listY3[params.dataIndex];
        console.log(params.dataIndex)
        console.log(obj)
        //console.log(self.listData.listY1[params.dataIndex])
        //console.log(self.listData.listY3listY3[params.dataIndex])
         WindowsEvent.MyDispatchEvent("SupplyPathCharPosition",self.listData.listY3[params.dataIndex]);
      });
    }
  }
};
